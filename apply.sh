...
original_author="Remediii"
original_name="flask_template_merito"
original_urlname="flask-template-merito"
original_description="Awesome flask_template_merito created by Remediii" 
...
rm -rf "${name}"
rm -rf tests
cp -R ${TEMPLATE_DIR}/flask_template_merito "${name}"
...
then
    ...
    echo "then run 'flask_template_merito' or 'python -m flask_template_merito'"
else
    poetry install
    echo "Applied Flask template"
    echo "Ensure you activate your env with 'poetry shell'"
    echo "then run 'flask_template_merito' or 'python -m flask_template_merito' or 'poetry run flask_template_merito'"
fi
